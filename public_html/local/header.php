...
<head>
	...
	<link rel="stylesheet" type="text/css" href="local/css/common-styles.css" />
    <link rel="icon" href="bitrix/templates/site/ico/favicon_bx.png">

    <!--[if lt IE 9]>
    <script src="js/vendor/modernizr-html5shiv-respond.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script src="bitrix/templates/site/js/vendor/modernizr.min.js"></script>
    <!--<![endif]-->
</head>
<body>
    <!--[if lt IE 8]>
